...
function vibe64SessionBriefing({
  ...
  const lines = [
    ...
    "",
    "Session database:",
    "- After a migration or any other database schema change, run `vibe64-database refresh` once so the session Database tool and ERD show the new schema. Do not edit Vibe64 session artifacts directly.",
    "",
    "Git and GitHub:",
