...
test("Vibe64 briefing keeps interactive browsing, browser versions, and installation under platform control", () => {
  ...
  assert.match(briefing, /accepts Playwright code only on stdin .*never as a positional argument/u);
